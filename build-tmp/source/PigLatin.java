...
//postcondition: returns the position of the first vowel in sWord.  If there are no vowels, returns -1
	...
	{
	  {
	    if(sWord.charAt(i) == 'a' || sWord.charAt(i) == 'i' || sWord.charAt(i) == 'u'){return i;}
	    else if(sWord.charAt(i) == 'e' || sWord.charAt(i) == 'o'){return i;}
	  }
	}
	return -1;
}
...
//postcondition: returns the pig latin equivalent of sWord
{
	...
	else if(sWord.substring(0,2)=="qu" || sWord.substring(0,2) == "Qu")
	{
		return sWord + "way";
	}
	else if(findFirstVowel(sWord) > 0)
